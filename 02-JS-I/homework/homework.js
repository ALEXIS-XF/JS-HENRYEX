...
console.log(devolverString("HOLIS"))
...
console.log(redondearNumero(1.234))

function redondearHaciaArriba(num) {    //ceil redonde un numero arriba 
  // Redondea "num" hacia arriba (al próximo entero) y devuélvelo
  // Tu código:
  return Math.ceil(num)
}

console.log(redondearHaciaArriba(1.234))
...
console.log(agregarSimboloExclamacion("messi"))
...
console.log(combinarNombres("CRISTIANO", "RONALDO"))
...
console.log(obtenerSaludo("MBAPPE"))
